...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    <?php foreach ($popularRecipes as $popularRecipe) : ?>
        ...
        <article class="bg-white rounded-lg overflow-hidden shadow-lg relative">
            ...
            <div class="p-4">
                <h3 class="text-xl font-bold mb-2"><?php echo $popularRecipe['name']?></h3>
                <div class="flex items-center mb-2">
                    <span class="text-yellow-500 mr-1"><i class="fas fa-star"></i></span>
                    <span>4.5</span>
                </div>
                <p class="text-gray-600"><?php echo truncateText($popularRecipe['description'], 100)?></p>
                <div class="flex items-center mt-4">
                    <span class="text-gray-700 mr-2"><?php echo $popularRecipe['username'];?></span>
