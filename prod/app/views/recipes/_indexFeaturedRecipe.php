...
<section class="relative mb-6">
    ...
    >
        <h1 class="text-3xl font-bold mb-2 text-white">
            <?php echo $featuredRecipe["recipe_name"]; ?>
        </h1>
        ...
        <p class="text-gray-300 mb-4">
            <?php echo truncateText($featuredRecipe["recipe_description"], 300); ?>
        </p>
        <div class="flex items-center mb-4">
        ...
        <a
            href="recipes/<?php echo $featuredRecipe['recipe_id']; ?>/<?php echo slugify($featuredRecipe['recipe_name']); ?>"
